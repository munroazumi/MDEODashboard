...
public class MaximiseSatisfaction implements IGuidanceFunction {
  ...
  public double computeFitness(final Solution solution) {
    final Function2<Double, EObject, Double> _function = (Double result, EObject customer) -> {
      Object _feature = this.getFeature(customer, "importance");
      Double _calculateSatisfaction = this.calculateSatisfaction(customer);
      double _multiply = DoubleExtensions.operator_multiply(((Double) _feature), _calculateSatisfaction);
      return Double.valueOf(((result).doubleValue() + _multiply));
    };
    Double satisfaction = IterableExtensions.<EObject, Double>fold(this.getReferenceFeature(solution.getModel(), "customers"), Double.valueOf(0.0d), _function);
  ...
  public Double calculateSatisfaction(final EObject customer) {
    ...
    {
      final Function1<EObject, Boolean> _function = (EObject v) -> {
        return Boolean.valueOf(IterableExtensions.isEmpty(this.getReferenceFeature(v, "contributesTo")));
      };
      final Iterable<EObject> directValuations = IterableExtensions.<EObject>filter(this.getReferenceFeature(customer, "assigns"), _function);
  ...
  public Double calculateFulfillment(final EObject requirement, final EObject customer) {
    ...
    {
      final Function1<EObject, Boolean> _function = (EObject r) -> {
        return Boolean.valueOf(this.isImplemented(r));
      };
      final Function1<EObject, Double> _function_1 = (EObject r) -> {
        Object _feature = this.getFeature(r, "percentage");
        return ((Double) _feature);
      };
      final Function2<Double, Double, Double> _function_2 = (Double result, Double perc) -> {
        return Double.valueOf(Math.max((result).doubleValue(), (perc).doubleValue()));
      };
      final Double maxRealisation = IterableExtensions.<Double, Double>fold(IterableExtensions.<EObject, Double>map(IterableExtensions.<EObject>filter(this.getReferenceFeature(requirement, "realisations"), _function), _function_1), Double.valueOf(0.0d), _function_2);
      final Iterable<EObject> dependencyValuations = this.getDependencyValuations(requirement, customer);
      double aggregatedDepFulfillments = 0.0d;
      boolean _isNullOrEmpty = IterableExtensions.isNullOrEmpty(dependencyValuations);
      boolean _not = (!_isNullOrEmpty);
      if (_not) {
        final Iterable<EObject> maxDependencyValuations = this.selectMaximalValuations(dependencyValuations);
        aggregatedDepFulfillments = (this.calcOverallFulfillmentContribution(maxDependencyValuations, customer)).doubleValue();
      }
   ...
   * customer.
   */
  public Iterable<EObject> getDependencyValuations(final EObject requirement, final EObject customer) {
    final Function1<EObject, Boolean> _function = (EObject v) -> {
      final Function1<EObject, Boolean> _function_1 = (EObject c) -> {
        return Boolean.valueOf((c == customer));
      };
      return Boolean.valueOf(IterableExtensions.<EObject>exists(this.getReferenceFeature(v, "assignedBy"), _function_1));
    };
    return IterableExtensions.<EObject>filter(this.getReferenceFeature(requirement, "combines"), _function);
  }
  ...
  public Iterable<EObject> selectMaximalValuations(final Iterable<EObject> valuations) {
    final Function1<EObject, Boolean> _function = (EObject v1) -> {
      final Function1<EObject, Boolean> _function_1 = (EObject v2) -> {
        return Boolean.valueOf((((v1 != v2) && (this.getFeature(v1, "requirement") == this.getFeature(v2, "requirement"))) && (((Double) this.getFeature(v1, "value")).compareTo(((Double) this.getFeature(v2, "value"))) <= 0)));
      };
   ...
   */
  public Double calcOverallFulfillmentContribution(final Iterable<EObject> valuations, final EObject customer) {
    double _xblockexpression = (double) 0;
    {
      final Function1<EObject, Boolean> _function = (EObject v) -> {
      ...
      final Function1<EObject, Double> _function_1 = (EObject v) -> {
        Object _feature = this.getFeature(v, "value");
        return ((Double) _feature);
      };
      final Function2<Double, Double, Double> _function_2 = (Double result, Double value) -> {
        return Double.valueOf(DoubleExtensions.operator_plus(result, value));
      };
      final Double sumOfWeights = IterableExtensions.<Double, Double>fold(IterableExtensions.<EObject, Double>map(valuations, _function_1), Double.valueOf(0.0d), _function_2);
      if (((sumOfWeights).doubleValue() == 0.0d)) {
        throw new IllegalArgumentException("The sum of valuation values may not be 0.");
      }
      final Function1<EObject, Double> _function_3 = (EObject v) -> {
        Object _feature = this.getFeature(v, "value");
        Object _feature_1 = this.getFeature(v, "requirement");
        Double _calculateFulfillment = this.calculateFulfillment(((EObject) _feature_1), customer);
        return Double.valueOf(DoubleExtensions.operator_multiply(((Double) _feature), _calculateFulfillment));
      };
      final Function2<Double, Double, Double> _function_4 = (Double result, Double weightedValue) -> {
        return Double.valueOf(DoubleExtensions.operator_plus(result, weightedValue));
      };
      Double _fold = IterableExtensions.<Double, Double>fold(IterableExtensions.<EObject, Double>map(valuations, _function_3), Double.valueOf(0.0d), _function_4);
  ...
  public boolean isImplemented(final EObject realisation) {
    final Function1<EObject, Boolean> _function = (EObject sa) -> {
      return Boolean.valueOf((this.isSelected(sa) && IterableExtensions.<EObject>forall(this.getReferenceFeature(sa, "requires"), ((Function1<EObject, Boolean>) (EObject reqSa) -> {
        return Boolean.valueOf(this.isSelected(reqSa));
      }))));
    };
    return IterableExtensions.<EObject>forall(this.getReferenceFeature(realisation, "dependsOn"), _function);
  }
  
  public boolean isSelected(final EObject softwareArtifact) {
    EObject _head = IterableExtensions.<EObject>head(this.getReferenceFeature(softwareArtifact, "solutions"));
    return (_head != null);
  }
