...
public class HasTheAllowedMaximalNumberOfSprints implements IGuidanceFunction {
  ...
  public double computeFitness(final Solution solution) {
    Object _feature = this.getFeature(solution.getModel(), "backlog");
    ...
    Object _feature_2 = this.getFeature(solution.getModel(), "sprints");
    ...
    InputOutput.<String>println(("Counted maximal desired sprints: " + Double.valueOf(desiredSprints)));
    ...
    boolean _greaterThan_1 = (_length_1 > desiredSprints);
    if (_greaterThan_1) {
