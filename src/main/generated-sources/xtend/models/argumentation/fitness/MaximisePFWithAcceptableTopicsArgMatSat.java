...
public class MaximisePFWithAcceptableTopicsArgMatSat implements IGuidanceFunction {
  @Override
  public double computeFitness(final Solution solution) {
    ...
    double fitness = acceptableTopicsCounter.countAcceptableTopicsArgMatSat();
    return (fitness * (-1));
  }
