...
public class MaximisePFWithAcceptableTopicsEqArgSolver implements IGuidanceFunction {
  @Override
  public double computeFitness(final Solution solution) {
    ...
    double fitness = acceptableTopicsCounter.countAcceptableTopicsEqArgSolver();
    return (fitness * (-1));
  }
