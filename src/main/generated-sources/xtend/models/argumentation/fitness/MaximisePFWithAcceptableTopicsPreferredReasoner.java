...
public class MaximisePFWithAcceptableTopicsPreferredReasoner implements IGuidanceFunction {
  @Override
  public double computeFitness(final Solution solution) {
    ...
    double fitness = acceptableTopicsCounter.countAcceptableTopicsPreferredReasoner();
    return (fitness * (-1));
  }
